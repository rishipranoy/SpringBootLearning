...
public class PeopleManagementSpringBootDataAppApplication  implements CommandLineRunner{
	...
	private void createNamedQueryMethods() {
		...
		// Resultset Comes with help of Named Query
		getPersonInfoByLastName("Rishi");
		
		// Resultset Comes with help of QueryMethod
		getPersonInfoByFirstNameAndEmail("Sony", "Sony@gmail.com");
		
		//Resultset Comes with help of Named Query
		// To make sure values are getting triggered by named Query itself 
		// I have changed the method name in interface to get instead of findBy
		getPersonInfoByLastNameAndEmail("kotwali", "rishi@gmail.com");
		
	}

	private void getPersonInfoByLastNameAndEmail(String lastName, String email) {
		List <Person> personsList = peopleManagementService.getPersonInfoByLastNameAndEmail(lastName,email);
...
//https://github.com/rishipranoy/SpringBootLearning.git
